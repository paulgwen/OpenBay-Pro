...
class ModelOpenbayEbay extends Model{
	public function install() {
		...
		$this->model_extension_event->addEvent('openbay_ebay_add_order', 'catalog/model/checkout/order/addOrderHistory/after', 'openbay/ebay/eventAddOrderHistory');
...
{country}';
	...
	public function verifyCredentials() {
		$this->request->post['domain'] = HTTPS_CATALOG;
