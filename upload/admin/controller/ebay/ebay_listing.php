<?php
class ControllerEbayEbayListing extends Controller {
	private $error = array();
	...
	public function bulkStep1() {
		...
		$this->template = 'ebay/ebay_bulk_step1.tpl';
	...
	public function bulkStep2() {
		...
		$this->template = 'ebay/ebay_bulk_step2.tpl';
	...
	public function bulkStep3() {
		...
		$this->template = 'ebay/ebay_bulk_step3.tpl';
	...
	public function bulkStep4() {
		...
		if (isset($this->session->data['bulk_category_list']['ebay_data'])) {
			...
			$this->template = 'ebay/ebay_bulk_step4.tpl';
