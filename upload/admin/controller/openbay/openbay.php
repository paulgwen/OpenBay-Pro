...
class ControllerOpenbayOpenbay extends Controller {
    ...
    public function index() {
		...
		$this->data['links_bulkcategory']       = $this->url->link('ebay/ebay_listing/bulkStep1', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function getEbayCategorySpecifics() {
		...
		$response = $this->model_ebay_openbay->getEbayCategorySpecifics($this->request->get['category_id']);
    ...
    public function verifyCredentials() {
        $this->load->model('ebay/openbay');
        $response = $this->model_ebay_openbay->verifyCredentials();
