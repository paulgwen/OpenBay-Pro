                ...
                <div id="tab-general">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <p><img src="<?php echo HTTPS_SERVER; ?>view/image/lock.png" style="margin-bottom:-3px;" />&nbsp;<a href="https://account.openbaypro.com/ebay/apiRegister/" target="_BLANK"><?php echo $lang_obp_token_register; ?></a></p>
                                <p><img src="<?php echo HTTPS_SERVER; ?>view/image/lock-open.png" style="margin-bottom:-3px;" />&nbsp;<a href="https://account.openbaypro.com/ebay/apiRenew/" target="_BLANK"><?php echo $lang_obp_token_renew; ?></a></p>
                                <p><img src="<?php echo HTTPS_SERVER; ?>view/image/lock-open.png" style="margin-bottom:-3px;" />&nbsp;<a href="http://account.openbaypro.com/ebay/apiUpdate/" target="_BLANK"><?php echo $lang_obp_detail_update; ?></a></p>
