...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a href="<?php echo $url_return; ?>" class="button"><?php echo $button_cancel; ?></a><a href="<?php echo $url_back; ?>" class="button"><?php echo $button_back; ?></a><a onclick="$('#product-form').submit();" class="button"><?php echo $button_submit; ?></a></div>
    </div>
    <div class="content">
